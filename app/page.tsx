...
export default async function Home() {
  ...
  const header = <header className="workspace-header"><Link href="/" className="workspace-brand"><span>M</span><strong>Mumu 평가</strong></Link><div><Link href="/demo">디자인 데모</Link>{loginReady && <UserButton />}</div></header>;
